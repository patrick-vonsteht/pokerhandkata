...
class PokerJudgeTest {
    ...
    private static final PokerHandComparisonRule notMatchingRule = mock(PokerHandComparisonRule.class);
    private static final PokerHandComparisonRule hand1WinningRule = mock(PokerHandComparisonRule.class);
    private static final PokerHandComparisonRule hand2WinningRule = mock(PokerHandComparisonRule.class);
    private static final PokerHandComparisonRule drawRule = mock(PokerHandComparisonRule.class);
